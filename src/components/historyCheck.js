        ...
        return (
            <div className="printFont">
                ...
                <table className="print" style={this.props.printOrPic ? { width: 'calc(100% - 10px)', margin: '0 auto', marginTop: '10px' } :
                    { width: 'calc(100% - 10px)', margin: '0 auto', marginTop: '20px', bottom: '15px', position: 'relative', border: '4px solid' }}>
                    <tbody>
                    <tr>
                            <td style={this.props.printOrPic ? { width: '30%' } : { width: '30%', borderRight: '4px solid' }}>日期</td>
                            <td>{this.props.dateTime}</td>
                        </tr>
                        <tr>
                            <td style={this.props.printOrPic ? {} : { borderRight: '4px solid' }}>編號</td>
                            <td>{this.props.number}</td>
                        </tr>
                        <tr>    
                            <td style={this.props.printOrPic ? {} : { borderRight: '4px solid' }}>承辦業務</td>
                            <td>{this.props.sale}</td>
                        </tr>
                        <tr>
                            <td style={this.props.printOrPic ? {} : { borderRight: '4px solid' }}>廠商</td>
                            <td>{this.props.factory}</td>
                        </tr>
                        <tr>
                            <td style={this.props.printOrPic ? {} : { borderRight: '4px solid' }}>廠商名稱</td>
                            <td>{this.props.name}</td>
                        </tr>
                        <tr>
                            <td style={this.props.printOrPic ? {} : { borderRight: '4px solid' }}>廠商電話</td>
                            <td>{this.props.phone}</td>
                        </tr>
                        <tr>
                            <td style={this.props.printOrPic ? {} : { borderRight: '4px solid' }}>施工時間</td>
                        ...
                        <tr>
                            <td style={this.props.printOrPic ? {} : { borderRight: '4px solid' }}>金額</td>
